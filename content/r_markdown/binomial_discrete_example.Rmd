---
title: Binomial Discrete with Bayes
slug: binomial_discrete_example
author: "Sean Ammirati"
date: '2018/07/29'
output: html_document
summary: Using a discrete Binomial prior to predict posterior probabilities. 
status: Published
---
```{r, echo=FALSE}
source("../../../statsworks/R/stats_examples/bayesian_analysis/Binomial Discrete Updater/binomial_discrete_updater_functions.R")
```
*Please note that the source code for the functions used in this example are available on my GitHub repository [here](https://github.com/SeanAmmirati/stats-works).*
